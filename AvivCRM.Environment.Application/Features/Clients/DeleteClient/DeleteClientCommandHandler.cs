...
internal class DeleteClientCommandHandler(IClient _clientRepository, IUnitOfWork _unitOfWork, IMapper mapper) : IRequestHandler<DeleteClientCommand, ServerResponse>
{
    public async Task<ServerResponse> Handle(DeleteClientCommand request, CancellationToken cancellationToken)
    {
        ...
        return new ServerResponse(IsSuccess: true, Message: "Client deleted successfully", Data: delMapEntity);
    }
}
