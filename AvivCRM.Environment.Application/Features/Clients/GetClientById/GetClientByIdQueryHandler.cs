...
internal class GetClientByIdQueryHandler(IClient clientRepository, IMapper mapper) : IRequestHandler<GetClientByIdQuery, ServerResponse>
{
    public async Task<ServerResponse> Handle(GetClientByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return new ServerResponse(IsSuccess: true, Message: "List of Client", Data: clientResponse);
    }
}