...
internal class UpdateLanguageCommandHandler(IValidator<UpdateLanguageRequest> _validator, ILanguage _languageRepository, IUnitOfWork _unitOfWork, IMapper mapper) : IRequestHandler<UpdateLanguageCommand, ServerResponse>
{
    public async Task<ServerResponse> Handle(UpdateLanguageCommand request, CancellationToken cancellationToken)
    {
        ...
        return new ServerResponse(IsSuccess: true, Message: "Language updated successfully", Data: languageEntity);
    }
}
