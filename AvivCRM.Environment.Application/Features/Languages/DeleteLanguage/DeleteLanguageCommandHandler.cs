...
internal class DeleteLanguageCommandHandler(ILanguage _languageRepository, IUnitOfWork _unitOfWork, IMapper mapper) : IRequestHandler<DeleteLanguageCommand, ServerResponse>
{
    public async Task<ServerResponse> Handle(DeleteLanguageCommand request, CancellationToken cancellationToken)
    {
        ...
        return new ServerResponse(IsSuccess: true, Message: "Language deleted successfully", Data: delMapEntity);
    }
}