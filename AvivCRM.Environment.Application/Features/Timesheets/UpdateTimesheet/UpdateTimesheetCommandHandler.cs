...
internal class UpdateTimesheetCommandHandler(IValidator<UpdateTimesheetRequest> _validator, ITimesheet _timesheetRepository, IUnitOfWork _unitOfWork, IMapper mapper) : IRequestHandler<UpdateTimesheetCommand, ServerResponse>
{
