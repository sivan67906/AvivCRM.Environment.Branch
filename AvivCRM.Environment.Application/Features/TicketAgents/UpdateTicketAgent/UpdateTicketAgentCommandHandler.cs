...
internal class UpdateTicketAgentCommandHandler(IValidator<UpdateTicketAgentRequest> _validator, ITicketAgent _ticketAgentRepository, IUnitOfWork _unitOfWork, IMapper mapper) : IRequestHandler<UpdateTicketAgentCommand, ServerResponse>
{
