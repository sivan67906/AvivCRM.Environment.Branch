...
internal class GetEmployeeByIdQueryHandler(IEmployee employeeRepository, IMapper mapper) : IRequestHandler<GetEmployeeByIdQuery, ServerResponse>
{
    public async Task<ServerResponse> Handle(GetEmployeeByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return new ServerResponse(IsSuccess: true, Message: "List of Employee", Data: employeeResponse);
    }
}