...
internal class DeleteJobApplicationPositionCommandHandler(IJobApplicationPosition _jobApplicationPositionRepository, IUnitOfWork _unitOfWork, IMapper mapper) : IRequestHandler<DeleteJobApplicationPositionCommand, ServerResponse>
{
    public async Task<ServerResponse> Handle(DeleteJobApplicationPositionCommand request, CancellationToken cancellationToken)
    {
        // Is Found
