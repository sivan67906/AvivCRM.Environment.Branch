...
internal class UpdateFinanceUnitSettingCommandHandler(IValidator<UpdateFinanceUnitSettingRequest> _validator, IFinanceUnitSetting _financeUnitSettingRepository, IUnitOfWork _unitOfWork, IMapper mapper) : IRequestHandler<UpdateFinanceUnitSettingCommand, ServerResponse>
{
    public async Task<ServerResponse> Handle(UpdateFinanceUnitSettingCommand request, CancellationToken cancellationToken)
    {
        // Validate Request
