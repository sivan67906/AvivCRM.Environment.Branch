    ...
    IMapper mapper) : IRequestHandler<GetFinancePrefixSettingByIdQuery, ServerResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        Domain.Entities.Finance.FinancePrefixSetting? financePrefixSetting = await financePrefixSettingRepository.GetByIdAsync(request.Id);
        ...
        GetFinancePrefixSetting? financePrefixSettingResponse =
