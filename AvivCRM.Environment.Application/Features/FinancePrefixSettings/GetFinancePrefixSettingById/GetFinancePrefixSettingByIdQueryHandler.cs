...
internal class GetFinancePrefixSettingByIdQueryHandler(IFinancePrefixSetting financePrefixSettingRepository, IMapper mapper) : IRequestHandler<GetFinancePrefixSettingByIdQuery, ServerResponse>
{
    public async Task<ServerResponse> Handle(GetFinancePrefixSettingByIdQuery request, CancellationToken cancellationToken)
    {
