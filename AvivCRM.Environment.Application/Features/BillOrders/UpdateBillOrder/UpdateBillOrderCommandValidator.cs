...
public class UpdateBillOrderCommandValidator : AbstractValidator<UpdateBillOrderRequest>
{
    public UpdateBillOrderCommandValidator()
    {
        RuleFor(x => x.Id)
                    .NotEmpty().WithMessage("Bill Order Id should not be empty");
        RuleFor(x => x.Prefix)
