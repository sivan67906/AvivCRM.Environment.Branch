...
internal class GetCurrencyByIdQueryHandler(ICurrency currencyRepository, IMapper mapper) : IRequestHandler<GetCurrencyByIdQuery, ServerResponse>
{
    public async Task<ServerResponse> Handle(GetCurrencyByIdQuery request, CancellationToken cancellationToken)
    {
        ...
        return new ServerResponse(IsSuccess: true, Message: "List of Currency", Data: currencyResponse);
    }
}